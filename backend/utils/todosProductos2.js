...
const productos = [
	...
	},
	{
		...
		nombre: "7818 camisa",
		marca: "mambo",
		descripcion: "camisa con 2 bolsillos ",
		precio: 15.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "1807 BUZO",
		marca: "mambo",
		descripcion: "BUZO NIÑO BORN CON CAPUCHA",
		precio: 20.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "1815 BUZO",
		marca: "mambo",
		descripcion: "BUZO CON CAPUCHA RUSTICO",
		precio: 22.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	{
		id: 36,
		nombre: "3775 CAMPERA RUSHER",
		marca: "mambo",
		descripcion: "CAMPERA RUSHER COMBINADA CON FORRO POLAR",
		precio: 25.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		marca: "mambo",
		descripcion: "PANTALON JEAN AZUL",
		precio: 5.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	{
		id: 38,
		nombre: "4795 PANTALON",
		marca: "mambo",
		descripcion: "PANTALÓN DEPORTIVO FRIZADO",
		precio: 8.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "7768 JOGGING",
		marca: "mambo",
		descripcion: "JOGGING FRIZA CON PUÑO",
		precio: 11.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		marca: "batistella",
		descripcion:
			"Los zapatillas son ideales para acompañarte esta temporada. Las zapatillas son de símil cuero en combinación con tela resistente tipo lona, forrados en su interior en poliéster. La planta es de goma, súper cómoda y livianas. El acceso es mediante cordones, la cual regula el agarre del pie. El diseño es clásico para que lo logres combinar en toda ocasión. No te pierdas este modelo súper canchero para tu hijo!",
		precio: 5.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "364",
		marca: "mambo",
		descripcion: "Remera estampada con moño atras",
		precio: 5.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "8262",
		marca: "mambo",
		descripcion: "remera UV mangas largas, salmon o rosa",
		precio: 7.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "6299",
		marca: "mambo",
		descripcion: "Buzo niña con capucha frisa 3 estampas over zise",
		precio: 8.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "6265",
		marca: "mambo",
		descripcion: "BUZO NEGRO NIÑA FRIZA TODAY",
		precio: 10.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "7330",
		marca: "mambo",
		descripcion: "CAMPERA ROSA FRIZA NIÑA LISA",
		precio: 11.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "5396",
		marca: "mambo",
		descripcion: "short rustico estampado con logo",
		precio: 5.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		marca: "mambo",
		descripcion: "mini jean degrade labrada",
		precio: 7.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		marca: "mambo",
		descripcion: "PANTALON JOGUING RUSTICO PESADO CON LOGO DE CORAZON NIÑA",
		precio: 8.5,
		oferta: {
			offActiva: false,
			Descuento: 0
	...
	},
	{
		...
		nombre: "7654",
		marca: "mambo",
		descripcion: "Pantalon rustico con estampa y tiras en el puño niñas",
		precio: 10.5,
		oferta: {
			offActiva: false,
			Descuento: 0
